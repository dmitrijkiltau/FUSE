...
Status: Active (`M2`, `M3`, and `M4` complete)  
...
| `M4` | Complete | `fuse build --release` now defaults to AOT output; explicit non-AOT path remains `fuse build`, and docs/tooling/tests were updated. |
