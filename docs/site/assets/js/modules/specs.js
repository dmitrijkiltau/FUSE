...
const SPECS = [
  { id: "fuse", title: "FUSE", path: "/site/specs/fuse.md" },
  { id: "fls", title: "FLS", path: "/site/specs/fls.md" },
  { id: "runtime", title: "Runtime", path: "/site/specs/runtime.md" },
  { id: "scope", title: "Scope", path: "/site/specs/scope.md" },
];
